...
- Versus-mode "garbage" pills (loose single halves that can land in any column, not just the spawn pair) aren't detected at all yet — no captures exist to design against.
